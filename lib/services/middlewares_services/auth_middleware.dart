...
class AuthMiddleware extends GetMiddleware {
  ...
  RouteSettings? redirect(String? route) {
    ...
    } else if (route == Routes.userHomeScreen &&    authController.isAdminX==true) {
      // Redirect to unauthorized page for admins
      return  null;
    }else if (route == Routes.userHomeScreen && authController.isUserX == false || authController.isAdminX==true) {
      // Redirect to unauthorized page for admins
      return RouteSettings(name: '/unauthorized');
    }
    return null;
